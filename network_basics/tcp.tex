...
\begin{frame}%{Three-way Handshake}
  ...
  \begin{iblock}{tcpdump output in terminal C:}
    ...
    \centering
    \mode<beamer>{ \includegraphics[width=.8\textwidth]{tcpdump} }%
...
\begin{frame}{TCPClient.py}
  \centering
  \mode<beamer>{ \includegraphics[width=.65\textwidth]{tcpClient-py} }%
...
\begin{frame}{TCPServer.py}
  \centering
  \mode<beamer>{ \includegraphics[width=.6\textwidth]{tcpServer-py} }%

...
\begin{frame}{Choosing The Right Tools}
  \mode<beamer>{
    \begin{center}
      \begin{tblr}{width=.7\linewidth,colspec=X[c]X[c]X[c],rowsep=0pt,%
          cell{Z}{1}={c=3}{c}%
        }
        ...
        {\scalebox{3}{\googleg}\quad\textcolor{gray}{{\Large vs.}}\quad\scalebox{3}{\baidu}}
      \end{tblr}
    \end{center}}%
  \mode<article>{
    \begin{center}
      \begin{tblr}{colspec={ccc},rowsep=0pt,cell{3}{1}={c=3}{c}}
        \win[false] &  & \apple[false] \\

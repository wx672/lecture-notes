...
\begin{frame}{HTTP Request (URL + Verb)}
  ...
  \end{iblock}
  \begin{center}
    \mode<beamer>{ \includegraphics[width=.9\textwidth]{http-Req} }%
...
\begin{frame}{Stateless Protocol}
  \begin{minipage}{.35\linewidth}
    ...
    \begin{itemize}
    \item[\good] Simplifies server design
    \item[\good] Save server resources
    \item[\good] Serve more users
    \item[\Bad] Missing information
    \end{itemize}
  \end{minipage}\hfill
...
\begin{frame}
  \begin{iblock}{\$ \texttt{ssh username@cs3.swfu.edu.cn}}
    \centering
    \mode<beamer>{ \includegraphics[width=.5\textwidth]{resolver} }%
...
\begin{frame}{SMTP Transports A Mail Object}
  \begin{iblock}{A Mail Object}
    \centering
    \mode<beamer>{ \includegraphics[width=.8\textwidth]{mail_obj} }%

...
echo 
echo "First, you need to make a new directory, say, 20141156888" | PV; prompt; 
...
echo "emacsclient 20141156888.org &" | PV; waiting
...
echo "cd .." | PV; prompt;
echo "tar zcf 20141156888.tgz 20141156888/" | PV; prompt;
echo "ls" | PV; waiting;

...
- Your report in either =Emacs Org= or =Markdown= format, and a PDF file
  ...
  - For =Markdown= to PDF, you can simply do =make pdf= if you are
	  using Linux in lab 215 and have these [[file:20231152xxx.yaml][=yaml file=]] and [[file:Makefile][=Makefile=]]
...
- A screencast file in =ttyrec= format recording your operations (=man ttyrec=).
  ...
  3. submit the =tgz= file to our [[https://cs6.swfu.edu.cn/moodle/mod/assign/view.php?id=885][moodle site]]. 
...
- Submit your report as a =tgz= file [[https://cs6.swfu.edu.cn/moodle/mod/assign/view.php?id=885][here]]. In your =tgz= file, there
  must be:

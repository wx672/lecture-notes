...
- Your report in either =Emacs Org= or =Markdown= format, and a PDF file
  ...
  Tips: 
  - Report template: [[file:20231159xxx.org][=org file=]], [[file:20231159xxx.md][=markdown file=]],
    [[file:20231159xxx.yaml][=yaml file=]], [[file:Makefile][=Makefile=]], and the generated [[file:20231159xxx.pdf][=pdf file=]].
  
  - In Emacs org-mode, press =C-c C-e l p= to export a PDF file.
     
  - For =Markdown= to PDF, you can simply do =make pdf= if you are
	  using Linux in the J219 lab and have these [[file:20231159xxx.yaml][=yaml file=]] and [[file:Makefile][=Makefile=]]

...
#+INFOJS_OPT: view:content toc:nil ltoc:nil mouse:underline buttons:0 path:http://cs3.swfu.edu.cn/org-info-js/org-info.js
...
#+include "~/git/lecture_notes/os/src/tiny.c" src c -n
   ...
   - See? Org-mode is easy. But you need more practice

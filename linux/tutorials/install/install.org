...
1. 先准备好一个安装盘（LiveUSB）
   1) *下载链接:* [[https://cdimage.debian.org/cdimage/release/current/amd64/bt-cd/debian-12.7.0-amd64-netinst.iso.torrent][https://cdimage.debian.org/cdimage/release/current/amd64/bt-cd/]]

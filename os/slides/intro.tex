...
\begin{frame}
  \begin{center}
    \mode<beamer>{ \includegraphics[width=.6\textwidth]{mos-figs-1-19} }%
...
\begin{frame}
  \begin{center}
    \mode<beamer>{ \includegraphics[width=1.01\textwidth]{osdi2-1-18} }%
...
\begin{frame}
  \begin{iblock}{The 11 steps in making the system call \texttt{read(fd,buffer,nbytes)}}
    \begin{center}
      \mode<beamer>{ \includegraphics[height=.9\textheight]{mos-figs-1-18} }%

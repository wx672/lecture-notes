...
\begin{frame}{Basic Memory Management}{Real Mode}
  \begin{iblock}{In the old days ... }
    ...
    \end{itemize}
    \centering
    \mode<beamer>{ \includegraphics[width=.85\textwidth]{mm-realmode} }%
...
\begin{frame}{Build A Static Library}{Makefile}
  \centering
  \mode<beamer>{ \includegraphics[height=.85\textheight]{makefile-a} }%
...
\begin{frame}{Build A Shared Library}{Source codes}
  \begin{iblock}{\texttt{hello.c}}
    \centering
      \mode<beamer>{ \includegraphics[width=.65\textwidth]{hello-c-so} }%
...
\begin{frame}{Build A Shared Library}{Makefile}
  \centering
  \mode<beamer>{ \includegraphics[height=.85\textheight]{makefile-so} }%

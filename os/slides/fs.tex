...
\begin{frame}{Directories}{Hierarchical Directory Systems}
  \begin{center}
    \mode<beamer>{ \includegraphics[width=\textwidth]{mos-figs-6-9} }%
...
\begin{frame}{I-node --- FCB in UNIX}
  \begin{minipage}{.5\textwidth}
    \begin{center}
      \mode<beamer>{ \includegraphics[width=1.5\textwidth]{inode-struct2} }%
...
\begin{frame}{UNIX Treats a Directory as a File}
  ...
  \mode<beamer>{\centering \includegraphics[width=.85\textwidth]{inode-struct}}
\end{frame}
...
\begin{frame}
  \begin{iblock}{Drawback}
    \begin{center}
      \mode<beamer>{ \includegraphics[width=.8\textwidth]{04-17} }%
...
\begin{frame}{Ext2 inode}
  ...
  \begin{center}
    \mode<beamer>{ \includegraphics[width=.7\textwidth]{osc-11-28} }
...
\begin{frame}
  \begin{center}
    \mode<beamer>{ \includegraphics[width=\textwidth]{vfs-objs} }%

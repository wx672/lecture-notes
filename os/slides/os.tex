...
\begin{frame}%{System Calls}
  \begin{center}
    \mode<beamer>{ \includegraphics[width=.7\textwidth]{mos-figs-1-19} }%
...
\begin{frame}{Pthreads}{Example 1}
  \begin{center}
    \mode<beamer>{ \includegraphics[width=.65\textwidth]{thread1} }%
...
\begin{frame}{Pthreads}{Example 2}
  \begin{center}
    ...
    \mode<article>{ \includegraphics[width=.9\textwidth]{thread2-bw} }
  \end{center}
\end{frame}
...
\begin{frame}{\texttt{clone()}}
  \begin{center}
    ...
    \mode<article>{ \includegraphics[width=.8\textwidth]{clone-prototype-bw} }
  \end{center}
  \begin{small}
    \begin{description}
...
\begin{frame}{\texttt{clone()} Example}
  \begin{center}
    \mode<beamer>{
      ...
      \end{tikzpicture}}%
    \mode<article>{ \includegraphics[width=.6\textwidth]{clone2-bw-crop} }
  \end{center}
\end{frame}
...
\begin{frame}{The Readers-Writers Problem}
  ...
  \end{description}
  \begin{center}
    \mode<beamer>{ \includegraphics[width=.8\textwidth]{reader-writer-1} }%

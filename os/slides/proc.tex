...
\begin{frame}{Linux Threads}
  ...
  \centering\includegraphics[width=.45\textwidth]{syscall}
\end{frame}
...
\begin{frame}{\texttt{clone()} Example}
  \mode<beamer>{
    ...
    \begin{tikzpicture}[remember picture, overlay]
      ...
      [anchor=east,xshift=-3em,yshift=3em,scale=8,text opacity=0.6,color=Green] {\Symbol{✔}};
    \end{tikzpicture}}%
...
\begin{frame}{IPC With FIFO}
  \mode<beamer>{ \includegraphics[height=.9\textheight]{fifo2-ipc} }%
...
\begin{frame}{Scheduling In Interactive Systems}{Priority Scheduling}
  \begin{center}
    \mode<beamer>{ \includegraphics[width=.7\textwidth]{mos-figs-2-42} }%
...
\begin{frame}{Resource-Allocation Graph}
  \begin{center}
    \includegraphics[width=.3\textwidth]{deadlock-graph-a}\qquad
    \includegraphics[width=.3\textwidth]{deadlock-graph-b}
  \end{center}

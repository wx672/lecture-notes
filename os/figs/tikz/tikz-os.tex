...
\begin{tikzpicture}
  ...
  {\includegraphics[width=\paperwidth]{mos-figs-3-3}};
  ...
  \begin{scope}[x={(image.south east)},y={(image.north west)}]%
    ...
    \node at (.04,.6) [anchor=west] {has};
    \node at (.38,.6) [anchor=west] {wants};
  \end{scope}
...
\begin{figure}
 ...
 \node (stdio-h) [right=2mm of hello-c,file] {Include files, macros\\(\texttt{stdio.h})};%
 \node (printf) [right=2mm of hello-o,file] {Libraries\\(\texttt{printf})};
...
\begin{figure}
  \centering
\begin{tikzpicture}[ decoration={random steps,segment length=4pt,amplitude=.7pt},%
  thick,%
  arrow/.style={thick,->,decorate},%
  squarebox/.style={decorate,draw,align=center,minimum width=2.2cm,minimum height=1cm,fill=blue!20},%
  dentrybox/.style={decorate,align=center,minimum height=1cm,fill=red!20},%
  cylinderbox/.style={decorate,draw,%
  ...
  \node (dentry) [dentrybox,draw,right=of f2.east,anchor=west,minimum width=4.5cm] {};%
  \node (dentry1) [dentrybox,right=of dentry.west,anchor=west,xshift=-.5cm,scale=.9] {dentry\\object};%
  \node (dentry2) [dentrybox,right=of dentry1,xshift=-.5cm,scale=.9] {dentry\\object};%
  \draw [decorate] (dentry1.north west) -- (dentry1.south west);%
  \draw [decorate] (dentry1.north east) -- (dentry1.south east);%
  \draw [decorate] (dentry2.north west) -- (dentry2.south west);%
  \draw [decorate] (dentry2.north east) -- (dentry2.south east);%
    
  \node (inode) [squarebox,fill=brown!20,above=2cm of dentry2] {inode\\object};%
  ...
  ($(dentry1.south west) + (0,-.3cm)$) -- (dentry1.south west);%
  \draw [arrow,dashed] (f3.east) -| (dentry2.south west);
  \draw [arrow,dotted] (dentry1.north) |- ($(inode.south west) + (.5cm,-1cm)$)%
  -| node [above,xshift=-.7cm,scale=.6] {d\_inode} ($(inode.south west) + (.5cm,0)$);%
  \draw [arrow,dotted] (dentry2) -- (inode);%
...
\begin{tikzpicture}[decoration={random steps,segment length=4pt,amplitude=.7pt},%
  thick,%
  arrow/.style={thick,->,decorate},%
  squarebox/.style={decorate,draw,align=center,minimum width=2.2cm,minimum height=1cm},%
  dentrybox/.style={decorate,align=center,minimum height=1cm},%
  cylinderbox/.style={decorate,draw,%
    cylinder,shape border rotate=90,aspect=.25,%
    cylinder uses custom fill,%
    cylinder body fill=gray!10, cylinder end fill=gray!30,%
  ...
  \node (dentry) [dentrybox,draw,right=of f2.east,anchor=west,minimum width=4.5cm] {};%
  \node (dentry1) [dentrybox,right=of dentry.west,anchor=west,xshift=-.5cm] {dentry\\object};%
  \node (dentry2) [dentrybox,right=of dentry1,xshift=-.5cm] {dentry\\object};%
  \draw [decorate] (dentry1.north west) -- (dentry1.south west);%
  \draw [decorate] (dentry1.north east) -- (dentry1.south east);%
  \draw [decorate] (dentry2.north west) -- (dentry2.south west);%
  \draw [decorate] (dentry2.north east) -- (dentry2.south east);%
    
  \node (inode) [squarebox,above=2cm of dentry2] {inode\\object};%
...
\end{tikzpicture}  
  \caption{VFS objects (bw version)}
...
\begin{tikzpicture}[%
  ...
  arrowbox/.style ={double arrow,rotate=90,scale=.7,fill=gray!50,%
    ...
    double arrow tip angle=135,%
    double arrow head extend=6pt},%
  every node/.style ={decorate,draw}%
  ] 

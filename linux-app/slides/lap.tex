...
\begin{frame}{Positional Parameters}{\cmd{\$0, \$1, \$2, \ldots, \$@, \$\#}}
  \begin{minipage}{.44\linewidth}
    \begin{center}
      ...
      \mode<article>{ \includegraphics[width=.7\textwidth]{isay-sh} }
    \end{center}
  \end{minipage}\quad
  \begin{minipage}{.52\linewidth}
    \begin{center}
      \mode<beamer>{ \includegraphics[width=\textwidth]{isay-c} }%
      \mode<article>{ \includegraphics[width=.8\textwidth]{isay-c} }
    \end{center}
  \end{minipage}
\end{frame}
  ...
  \begin{block}{Example}
    \begin{center}
      \begin{center}
        ...
        \mode<article>{ \includegraphics[width=.4\textwidth]{para-substitution-sh} }
      \end{center}
    \end{center}
  \end{block}
\end{frame}
...
\begin{frame}[allowframebreaks]{Tests}\small\ttfamily
  ...
  \begin{block}{}
    \begin{center}
      ...
      \mode<article>{ \includegraphics[width=.4\textwidth]{if-then-else-sh} }
    \end{center}
  \end{block}
\end{frame}
...
\begin{frame}{\texttt{case}}
  \begin{center}
    \includegraphics[width=.8\linewidth]{n2-sh}
  \end{center}
\end{frame}
...
\begin{frame}{\texttt{select}}
  \begin{center}
    ...
    \mode<article>{ \includegraphics[width=.5\textwidth]{select-sh} }
  \end{center}
\end{frame}
...
\begin{frame}{Functions}
  \begin{center}
    ...
    \mode<article>{ \includegraphics[width=.8\textwidth]{func-sh} }
  \end{center}
\end{frame}
  ...
  \begin{minipage}[t]{.47\linewidth}
    \begin{block}{\texttt{main.c}}
      \begin{center}
        ...
        \mode<article>{ \includegraphics[width=.7\textwidth]{main-c} }
      \end{center}
    \end{block}
  ...
  \begin{minipage}[t]{.43\linewidth}
    \begin{block}{\texttt{hello.c}}
      \begin{center}
        ...
        \mode<article>{ \includegraphics[width=.7\textwidth]{hello-c} }
      \end{center}
    \end{block}
    \begin{block}{\texttt{hi.c}}
      \begin{center}
        \mode<beamer>{ \includegraphics[width=\textwidth]{hi-c} }%
        \mode<article>{ \includegraphics[width=.7\textwidth]{hi-c} }
      \end{center}
    \end{block}
  \end{minipage}
\end{frame}
...
\begin{frame}{Build A Static Library}{Makefile}
  \begin{center}
    ...
    \mode<article>{ \includegraphics[width=.5\textwidth]{makefile-a} }
  \end{center}
\end{frame}
...
\begin{frame}{Build A Shared Library}{Source codes}
  \begin{block}{\texttt{hello.c}}
    \begin{center}
      ...
      \mode<article>{ \includegraphics[width=.6\textwidth]{hello-c-so} }
    \end{center}
  \end{block}
  \begin{minipage}{.35\linewidth}
    \begin{block}{\texttt{hello.h}}
      \begin{center}
        ...
        \mode<article>{ \includegraphics[width=.6\textwidth]{hello-h-so} }
      \end{center}
    \end{block}
  \end{minipage}\qquad
  \begin{minipage}{.36\linewidth}
    \begin{block}{\texttt{hi.c}}
      \begin{center}
        ...
        \mode<article>{ \includegraphics[width=.6\textwidth]{hi-c-so} }
      \end{center}
    \end{block}
  \end{minipage}
\end{frame}
...
\begin{frame}{Build A Shared Library}{Makefile}
  \begin{center}
    ...
    \mode<article>{ \includegraphics[width=.7\textwidth]{makefile-so} }
  \end{center}
\end{frame}
...
\begin{frame}{Man Page}{Groff source code}
  \begin{minipage}[b]{.6\linewidth}
    \begin{center}
      ...
      \mode<article>{ \includegraphics[width=1.2\textwidth]{manpage-1} }
    \end{center}
  \end{minipage}
...
\begin{frame}{Example}
  \begin{center}
    ...
    \mode<article>{ \includegraphics[width=.4\textwidth]{h-asm} }
  \end{center}
  \begin{block}{}
    \ttfamily
    \begin{enumerate}
...
\begin{frame}{Command Line Options}{\texttt{getopt.c}}
  \begin{center}
    ...
    \mode<article>{ \includegraphics[width=.6\textwidth]{getopt-c} }
  \end{center}
...
\begin{frame}{Command Line Options}{\texttt{getopt.sh}}
  \begin{center}
    ...
    \mode<article>{ \includegraphics[width=.6\textwidth]{getopt-sh} }
  \end{center}
  \ttfamily
  \begin{itemize}
  \item[\$] ./getopt.sh -h
...
\begin{frame}{Environment Variable}
  \begin{minipage}{.5\linewidth}
    \begin{center}
      ...
      \mode<article>{ \includegraphics[width=.6\textwidth]{env-c} }
    \end{center}
  \end{minipage}\quad
  \begin{minipage}{.45\linewidth}
  \ttfamily
...
\begin{frame}{Time and Date}
  \begin{center}
    ...
    \mode<article>{ \includegraphics[width=.5\textwidth]{time-c} }
  \end{center}
  \begin{itemize}
  ...
  \begin{minipage}[t]{.55\linewidth}
    \begin{block}{\texttt{mkstemp.c}}
      \begin{center}
        ...
        \mode<article>{ \includegraphics[width=.8\textwidth]{mkstemp-c} }
      \end{center}
    \end{block}
  \end{minipage}\qquad
  \begin{minipage}[t]{.35\linewidth}
    \begin{block}{\texttt{mktemp.sh}}
      \begin{center}
        ...
        \mode<article>{ \includegraphics[width=.7\textwidth]{mktemp-sh} }
      \end{center}
    \end{block}
    \begin{itemize}
    \item[\$] man 3 mkstemp
...
\begin{frame}{Logging}
  \begin{block}{\ttfamily syslog.c}
    \begin{center}
      ...
      \mode<article>{ \includegraphics[width=.6\textwidth]{syslog-c} }
    \end{center}
  \end{block}
  \begin{block}{\ttfamily logger.sh}
    \begin{center}
      \mode<beamer>{ \includegraphics[width=\textwidth]{logger-sh} }%
      \mode<article>{ \includegraphics[width=.7\textwidth]{logger-sh} }
    \end{center}
  \end{block}
  % \ttfamily
  % \begin{itemize}
  ...
  \begin{minipage}[t]{.53\linewidth}
    \begin{block}{\texttt{write()}}
      \begin{center}
        ...
        \mode<article>{ \includegraphics[width=.7\textwidth]{write-c} }
      \end{center}
    \end{block}
    \ttfamily
    \begin{itemize}
  ...
  \begin{minipage}[t]{.37\linewidth}
    \begin{block}{\texttt{read()}}
      \begin{center}
        ...
        \mode<article>{ \includegraphics[width=.7\textwidth]{read-c} }
      \end{center}
    \end{block}
    \ttfamily
    \begin{itemize}
...
\begin{frame}{\cmd{cp}}
  \begin{center}
    \begin{center}
      ...
      \mode<article>{ \includegraphics[width=.8\textwidth]{cp-syscall-c} }
    \end{center}
  \end{center}
\end{frame}
...
\begin{frame}{\texttt{cp} --- {\small With} \texttt{stdio}}
  \begin{center}
    ...
    \mode<article>{ \includegraphics[width=.4\textwidth]{cp-libc-c} }
  \end{center}
  \begin{description}
...
\begin{frame}%{Directory}
  \begin{block}{Directory entry in \texttt{glibc}}
    \begin{center}
      ...
      \mode<article>{ \includegraphics[width=.6\textwidth]{dirent-c} }
    \end{center}
  \end{block}
  \begin{itemize}
...
\begin{frame}{\ttfamily ls}
  ...
  \begin{minipage}{.6\linewidth}
    \begin{center}
      ...
      \mode<article>{ \includegraphics[width=.7\textwidth]{ls-c} }
    \end{center}
  \end{minipage}\quad
  \begin{minipage}{.35\linewidth}
    \begin{description}
...
\begin{frame}{\ttfamily mkdir(), chdir(), rmdir(), getcwd()}
  \begin{center}
    ...
    \mode<article>{ \includegraphics[width=.5\textwidth]{mkdir-c} }
  \end{center}
\end{frame}
...
\begin{frame}{\ttfamily link(), unlink(), symlink()}
  \begin{center}
    ...
    \mode<article>{ \includegraphics[width=.4\textwidth]{link-c} }
  \end{center}
\end{frame}

...
\lecture{start}{start}% [short name]<name><label>
...
\begin{frame}
  ...
  \begin{center}
    ...
    \mode<article>{ \includegraphics[width=.6\textwidth]{dynamic-linking} }
  \end{center}
\end{frame}
...
\begin{frame}{Build A Static Library}{Source codes}
  \begin{minipage}[t]{.47\linewidth}
    \begin{block}{\texttt{main.c}}
      \includegraphics[width=\textwidth]{main-c}
    \end{block}
  ...
  \begin{minipage}[t]{.43\linewidth}
    \begin{block}{\texttt{hello.c}}
      \includegraphics[width=\textwidth]{hello-c}
    \end{block}
...
\begin{frame}{Build A Static Library}{Makefile}
  \includegraphics[width=.8\textwidth]{makefile-a}
\end{frame}

\begin{frame}{Build A Shared Library}{Source codes}
  \begin{block}{\texttt{hello.c}}
    \includegraphics[width=.8\textwidth]{hello-c-so}
  \end{block}
  \begin{minipage}{.35\linewidth}
    \begin{block}{\texttt{hello.h}}
      \includegraphics[width=\textwidth]{hello-h-so}
    \end{block}
  \end{minipage}\qquad
  \begin{minipage}{.36\linewidth}
    \begin{block}{\texttt{hi.c}}
      \includegraphics[width=\textwidth]{hi-c-so}
    \end{block}
  \end{minipage}
\end{frame}
...
\begin{frame}{Build A Shared Library}{Makefile}
  \includegraphics[width=\textwidth]{makefile-so}
\end{frame}
...
\begin{frame}{Understanding ``\texttt{ls -l}''}
  \begin{minipage}{.71\linewidth}
    \includegraphics[width=\linewidth]{ls-l}
  \end{minipage}\quad
  ...
  \begin{block}{9-bit permission}
    \begin{minipage}{.27\linewidth}
      \includegraphics[width=\linewidth]{9bit}
    \end{minipage}\quad
...
\lecture{Shell Programming}{Bash}
...
\begin{frame}{Positional Parameters}{\cmd{\$0, \$1, \$2, \ldots, \$@, \$\#}}
  \begin{minipage}{.44\linewidth}
    \includegraphics[width=\linewidth]{isay-sh}
  \end{minipage}\quad
  \begin{minipage}{.52\linewidth}
    \includegraphics[width=\linewidth]{isay-c}
  \end{minipage}
\end{frame}
...
\begin{frame}{Parameter Substitution}
  ...
  \begin{block}{Example}
    \begin{center}
      \includegraphics[width=.6\linewidth]{para-substitution-sh}
    \end{center}
  \end{block}
\end{frame}
...
\begin{frame}[allowframebreaks]{Tests}\small\ttfamily
  ...
  \begin{block}{}
    \begin{center}
      \includegraphics[width=.7\linewidth]{if-then-else-sh}
    \end{center}
  \end{block}
\end{frame}
...
\begin{frame}{\texttt{select}}
  \begin{center}
    \includegraphics[width=\linewidth]{select-sh}
  \end{center}
\end{frame}

\begin{frame}{Functions}
  \includegraphics[width=\linewidth]{func-sh}
\end{frame}

\lecture{OS Basics}{os}
\section{OS Basics}
\label{sec:os-basics}
...
\begin{frame}{Example}
  \begin{center}
    \includegraphics[width=.8\linewidth]{h-asm}
  \end{center}
  \begin{block}{}
    \ttfamily
    \begin{enumerate}
...
\lecture{Working with files}{file}
...
\begin{frame}{Implementing Files}
  ...
  \end{description}
    \begin{center}
      \mode<beamer>{ \includegraphics[width=.8\textwidth]{file-alloc-contiguous} }%
...
\begin{frame}
  ...
  \end{description}
  \begin{center}
    \mode<beamer>{ \includegraphics[width=.8\textwidth]{file-alloc-chained} }%
...
\begin{frame}
  ...
  \end{description}
  \begin{center}
    \mode<beamer>{ \includegraphics[width=.8\textwidth]{file-alloc-idx} }%
...
\begin{frame}
  \begin{minipage}[t]{.53\linewidth}
    \begin{block}{\texttt{write()}}
      \includegraphics[width=\linewidth]{write-c}
    \end{block}
    \ttfamily
    \begin{itemize}
    \item[\$] man 2 write
  ...
  \begin{minipage}[t]{.37\linewidth}
    \begin{block}{\texttt{read()}}
      \includegraphics[width=\linewidth]{read-c}
    \end{block}
    \ttfamily
    \begin{itemize}
    \item[\$] man 2 read
...
\begin{frame}{\texttt{cp} --- {\small With} \texttt{stdio}}
  \begin{center}
    \includegraphics[width=.6\linewidth]{cp-libc-c}
  \end{center}
  \begin{description}
...
\begin{frame}{\ttfamily ls}
  ...
  \begin{minipage}{.6\linewidth}
    \includegraphics[width=\linewidth]{ls-c}
  \end{minipage}\quad
  \begin{minipage}{.35\linewidth}
    \begin{description}
...
\begin{frame}{\ttfamily mkdir(), chdir(), rmdir(), getcwd()}
  \begin{center}
    \includegraphics[width=.9\linewidth]{mkdir-c}
  \end{center}
\end{frame}
...
\begin{frame}{Command Line Options}{\texttt{getopt.c}}
  \begin{center}
    \includegraphics[width=.7\linewidth]{getopt-c}
  \end{center}
...
\begin{frame}{Command Line Options}{\texttt{getopt.sh}}
  \begin{center}
    \includegraphics[width=.9\linewidth]{getopt-sh}    
  \end{center}
  \ttfamily
  \begin{itemize}
  \item[\$] ./getopt.sh -h
...
\begin{frame}{Environment Variable}
  \begin{minipage}{.5\linewidth}
    \includegraphics[width=\linewidth]{env-c}
  \end{minipage}\quad
  \begin{minipage}{.45\linewidth}
  \ttfamily
  \begin{itemize}
...
\begin{frame}{Time and Date}
  \begin{center}
    \includegraphics[width=.7\textwidth]{time-c}
  \end{center}
  \begin{itemize}
...
\begin{frame}{Temporary Files}
  ...
  \begin{minipage}[t]{.55\linewidth}
    \begin{block}{\texttt{mkstemp.c}}
      \includegraphics[width=\linewidth]{mkstemp-c}
    \end{block}
  \end{minipage}\qquad
  \begin{minipage}[t]{.35\linewidth}
    \begin{block}{\texttt{mktemp.sh}}
      \includegraphics[width=\linewidth]{mktemp-sh}
    \end{block}
    \begin{itemize}
    \item[\$] man 3 mkstemp
    \item[\$] man 3 tmpfile
...
\begin{frame}{Logging}
  \begin{block}{\ttfamily syslog.c}
    \includegraphics[width=.8\linewidth]{syslog-c}
  \end{block}
  \begin{block}{\ttfamily logger.sh}
    \includegraphics[width=\linewidth]{logger-sh}
  \end{block}
  % \ttfamily
  % \begin{itemize}
  % \item[\$] man 3 syslog

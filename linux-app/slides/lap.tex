...
\begin{frame}{\texttt{popen()}}
  ...
  \citetitle[Sec.~15.3]{stevens2013advanced}
...
\begin{frame}{Message Queues}
  \begin{center}
    \begin{minipage}{.3\linewidth}
      \includegraphics[width=\linewidth]{mq}
    \end{minipage}\qquad
    \begin{minipage}{.3\linewidth}
...
\begin{center}
  ...
  \mode<article>{ \includegraphics[width=.7\textwidth]{mq-send-bw} }
\end{center}
\end{frame}
...
\begin{center}
  ...
  \mode<article>{ \includegraphics[width=.7\textwidth]{mq-recv-bw} }
\end{center}
\end{frame}
...
\begin{frame}{Example}% Signaling with semaphore
  \begin{center}
    ...
    \mode<article>{ \includegraphics[width=.7\textwidth]{thread3-bw} }
  \end{center}
\end{frame}
...
\begin{center}
  ...
  \mode<article>{ \includegraphics[width=.6\textwidth]{atomic-non-bw} }
\end{center}
\end{frame}
...
\begin{center}
  ...
  \mode<article>{ \includegraphics[width=.6\textwidth]{atomic-mutex-bw} }
\end{center}
\end{frame}
...
\begin{center}
  ...
  \mode<article>{ \includegraphics[width=.5\textwidth]{mutex-bw} }
\end{center}
\end{frame}
